...
//it will Define an interface for the opportunity object
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //it will Function to render opportunities dynamically
    ...
    //it will Function to show the modal
    function showModal() {
    ...
    //it will Function to hide the modal
    function hideModal() {
        if (signUpModal) { // Null check
    ...
    // it will Prepare the sign-up modal with event details
    ...
    // it will Close the modal when the close button is clicked
    if (closeModalButton) {
    ...
    // it will Close the modal when clicking outside the modal
